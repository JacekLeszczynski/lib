...
{ ----------------------- KOD CRYPTO ----------------------------- }
function CalcBuffer(aLen: integer): integer; cdecl; external 'libecode_c.so' name 'fCalcBuffer';
...
function fEncryptString(var buf: pchar; len: integer; IV,key: pchar): integer; cdecl; external 'libecode_c.so' name 'fEncryptString';
function fDecryptString(var buf: pchar; len: integer; IV,key: pchar): integer; cdecl; external 'libecode_c.so' name 'fDecryptString';
function fEncryptBinary(var buf: pchar; len: integer; IV,key: pchar): integer; cdecl; external 'libecode_c.so' name 'fEncryptBinary';
function fDecryptBinary(var buf: pchar; len: integer; IV,key: pchar): integer; cdecl; external 'libecode_c.so' name 'fDecryptBinary';
function fEncryptStringOnlyPassword(var buf: pchar; len: integer; key: pchar): integer; cdecl; external 'libecode_c.so' name 'fEncryptStringOnlyPassword';
function fDecryptStringOnlyPassword(var buf: pchar; len: integer; key: pchar): integer; cdecl; external 'libecode_c.so' name 'fDecryptStringOnlyPassword';
function fBase64EncodeBin(const bufor: pchar; len: integer): pchar; cdecl; external 'libecode_c.so' name 'fBase64EncodeBin';
function fBase64DecodeBin(const text: pchar; var bufor: pchar): integer; cdecl; external 'libecode_c.so' name 'fBase64DecodeBin';
function fEncryptStr(text,key: pchar): pchar; cdecl; external 'libecode_c.so' name 'fEncryptStr';
function fDecryptStr(text,key: pchar): pchar; cdecl; external 'libecode_c.so' name 'fDecryptStr';
function fReadConfigFile(const filename: pchar; buffer: pchar; buffer_size: integer): integer; cdecl; external 'libecode_c.so' name 'fReadConfigFile';
function fReadConfigFileString(elementy, element: pchar): pchar; cdecl; external 'libecode_c.so' name 'fReadConfigFileString';
